---
name: Bug Report
about: Report a bug to help us improve FXOS
title: '[BUG] '
labels: bug
assignees: ''
---
...
**Manual/PM2 users:**
```bash
# Terminal output where you ran: ./fxos
# OR PM2 logs:
pm2 logs fxos --lines 100
```
...
- **FXOS Version:** [run: `git log -1 --oneline` or check release tag]
...
9. ✅ Verify backend is running: `docker compose ps` or `ps aux | grep fxos`
