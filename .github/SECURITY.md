...
We take the security of FXOS seriously. This document outlines our security policy and procedures for reporting vulnerabilities.
...
- **Email**: onecany+github@gmail.com (or contact maintainers directly via Twitter DM)
...
If you're using FXOS, please follow these security best practices:
...
FXOS uses the following security measures:
...
- **Email**: Contact maintainers (see [GitHub profile](https://github.com/onecany/FXOS))
...
Thank you for helping keep FXOS and its users safe! 🙏
