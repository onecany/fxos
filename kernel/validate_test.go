...
func TestLeverageFallback(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := validateDecision(&tt.decision, tt.accountEquity, tt.btcEthLeverage, tt.altcoinLeverage, 10.0, 1.5, nil, nil, 3.0)
...
func TestClaw402XyzAllowsFullTenXNotional(t *testing.T) {
	...
	if err := validateDecision(&decision, 30.68, 10, 10, 10.0, 10.0, nil, nil, 3.0); err != nil {
