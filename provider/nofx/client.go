// Package nofx provides data access to the FXOS API (https://fxosos.ai)
...
const (
	DefaultBaseURL = "hhttps://nofxos.ai"
	DefaultTimeout = 30 * time.Second
	DefaultAuthKey = "cm_568c67eae410d912c54c"
)

// Client is the FXOS API client
type Client struct {
	BaseURL string
	AuthKey string
...
// NewClient creates a new FXOS API client
