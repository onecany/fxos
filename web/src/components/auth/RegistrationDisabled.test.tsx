...
describe('RegistrationDisabled Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display the FXOS logo', () => {
      renderComponent()
      const logo = screen.getByAltText('FXOS Logo')
      expect(logo).toBeTruthy()
      expect(logo.getAttribute('src')).toBe('/icons/fxos.svg')
    })
  ...
  describe('Styling', () => {
    it('should have correct theme classes', () => {
      const { container } = renderComponent()
      const mainDiv = container.firstChild as HTMLElement
      expect(mainDiv.className).toContain('bg-fxos-bg')
      expect(mainDiv.className).toContain('text-fxos-text')
    })
