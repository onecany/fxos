...
export function ChartWithOrders({
        ...
        if (traderID) {
          ...
          orders.forEach((order) => {
            ...
            markers.push({
              ...
              color: isBuy ? 'var(--fxos-success)' : 'var(--fxos-danger)',
  ...
  return (
    <div className="relative rounded-xl overflow-hidden border border-[rgba(45,212,191,0.16)] bg-fxos-bg-deeper">
      {/* Title bar */}
      ...
      {error && (
        ...
        >
          <div className="text-center">
            ...
            <div style={{ color: 'var(--fxos-danger)' }}>{error}</div>
          </div>
        </div>
      )}
