          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {[
                {
                  icon: Command,
                  label: t('landing.featureInstallLabel', language),
                  desc: t('landing.featureInstallDesc', language),
                },
                {
                  icon: Shield,
                  label: t('landing.featureKeysLabel', language),
                  desc: t('landing.featureKeysDesc', language),
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-start p-4 rounded bg-fxos-bg-lighter border border-[var(--panel-border)] hover:border-fxos-gold/30 transition-colors group"
                >
                  ...
                  <div>
                    <h4 className="text-fxos-text font-bold font-mono text-sm mb-1">
                      {item.label}
                    </h4>
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden bg-fxos-bg-lighter border border-[var(--panel-border)] shadow-lg">
              ...
              <div className="p-8 font-mono text-sm md:text-base bg-fxos-bg-lighter min-h-[200px] flex flex-col justify-center">
                <div className="mb-2 text-fxos-text-muted text-xs tracking-wide">
                  # Initialize FXOS Core Protocol
                </div>
                <div
                  ...
                  onClick={handleCopy}
                >
                  <span className="text-fxos-gold mt-1">
