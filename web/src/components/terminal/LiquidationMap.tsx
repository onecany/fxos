  ...
  return (
    <div style={{ fontFamily: 'var(--tm-mono)' }}>
      ...
      >
        ...
        >
          {view.rows.length
            ? t('costLiqMapLive', language)
            : isLoading
              ? t('costLiqMapSync', language)
              : '○ —'}
        </span>
      </div>
      ...
      >
        {hv ? (
          <span>
            <b>{fmtPx(hv.px)}</b> · {t('costLine', language)}{' '}
          ...
          <span className="tm-sc">
            ...
            · {view.costAddrs.toLocaleString()} {t('positionsLabel', language)}{' '}
            / {view.liqAddrs.toLocaleString()} {t('liqLevels', language)}
          </span>
        )}
      </div>
      ...
      {error && !view.rows.length ? (
        <div className="tm-sc" style={{ padding: '16px 0' }}>
          {t('noHeatmap', language)} {view.dispSymbol}
        </div>
      ) : !view.rows.length ? (
        <div className="tm-sc" style={{ padding: '16px 0' }}>
          {t('loadingHeatmap', language)}
        </div>
      ) : (
        <div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background:
                      hover === i
                        ? 'color-mix(in srgb, var(--tm-ink) 6%, transparent)'
                        : 'transparent',
