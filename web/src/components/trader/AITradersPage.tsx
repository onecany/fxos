  ...
  return (
    <DeepVoidBackground className="py-8" disableAnimation>
      <div className="w-full px-4 md:px-8 space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-fxos-gold/20 pb-6">
          <div className="flex items-center gap-4">
            <div className="relative group">
              ...
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center bg-fxos-bg-lighter border border-fxos-gold/30 text-fxos-gold relative z-10">
                <Bot className="w-6 h-6 md:w-7 md:h-7" />
              </div>
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold font-mono tracking-tight text-fxos-text flex items-center gap-3 uppercase">
                {t('aiTraders', language)}
                <span className="text-xs font-mono font-normal px-2 py-0.5 rounded bg-fxos-gold/10 text-fxos-gold border border-fxos-gold/20 tracking-wider">
                  {traders?.length || 0} ACTIVE_NODES
                </span>
              </h1>
              <p className="text-xs font-mono text-fxos-text-muted uppercase tracking-widest mt-1 ml-1 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-fxos-success animate-pulse"></span>
                SYSTEM_READY
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 hide-scrollbar">
            <button
              ...
              className="px-4 py-2 rounded text-xs font-mono uppercase tracking-wider transition-all border border-fxos-gold/20 bg-fxos-bg-lighter text-fxos-text-muted hover:text-fxos-text hover:border-fxos-gold/40 whitespace-nowrap"
            >
              <div className="flex items-center gap-2">
                <Plus className="w-3 h-3" />
                <span>{t('modelsConfig', language)}</span>
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-2">
                <Plus className="w-3 h-3" />
                <span>{t('exchangeKeys', language)}</span>
              </div>
            </button>

            <button
              onClick={() => setShowTelegramModal(true)}
              className="px-4 py-2 rounded text-xs font-mono uppercase tracking-wider transition-all border border-fxos-accent/30 bg-fxos-bg-lighter text-fxos-accent hover:text-fxos-gold hover:border-fxos-accent/50 whitespace-nowrap"
            >
              <div className="flex items-center gap-2">
                <MessageCircle className="w-3 h-3" />
                <span>{t('telegramBot', language)}</span>
              </div>
            </button>
            ...
            <button
              ...
              className="group relative px-6 py-2 rounded text-xs font-bold font-mono uppercase tracking-wider transition-all disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap overflow-hidden bg-fxos-gold text-white hover:bg-fxos-accent"
            >
