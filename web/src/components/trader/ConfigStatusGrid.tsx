  ...
  const getExchangeStateMeta = (state: ExchangeAccountState | undefined) => {
    if (!state) {
      return {
        ...
        className:
          'text-fxos-text-muted border-[var(--panel-border)] bg-fxos-bg-deeper',
      }
    }
    ...
    switch (state.status) {
      case 'ok':
        return {
          ...
          className:
            'text-fxos-success border-fxos-success/20 bg-fxos-success/10',
        }
      case 'disabled':
        return {
        ...
        <div className="p-4 space-y-3">
                  ...
                  <div className="relative">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center bg-fxos-bg border border-[var(--panel-border)] relative z-10">
                      {getModelIcon(model.provider || model.id, {
                        ...
                        <span className="text-xs font-bold text-fxos-accent">
          ...
          {configuredModels.length === 0 && (
            <div className="text-center py-10 border border-dashed border-[var(--panel-border)] rounded-lg bg-fxos-bg-deeper">
              ...
              <div className="text-xs font-mono text-fxos-text-muted uppercase tracking-widest">
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {isCopied ? (
                            <Check size={10} className="text-fxos-success" />
                          ) : (
                            <Copy size={10} />
                          )}
                        </button>
