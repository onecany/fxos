  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tabs */}
        <div
          className="flex gap-1 px-6 pt-3 border-b overflow-x-auto flex-nowrap"
          style={{ borderColor: 'var(--panel-border)' }}
        >
          {tabs.map((tab) => (
            <button
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
            ...
            <div className="space-y-4">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <span style={{ color: 'var(--text-primary)' }}>
                        $
                        {decision.account_state.total_unrealized_profit?.toFixed(
                          2
                        )}
                      </span>
                    </div>
              ...
              <div>
                <h3
                  ...
                  style={{ color: 'var(--text-primary)' }}
                >
                  {t('decisions', language)} ({decision.decisions?.length || 0})
                </h3>
          ...
          {activeTab === 'system' && (
            <div
              className="rounded-lg p-4 text-sm font-mono whitespace-pre-wrap max-h-[60vh] overflow-y-auto"
              style={{
                background: 'var(--fxos-bg-lighter)',
                border: '1px solid var(--panel-border)',
...
function ActionDetailCard({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        {action.confidence !== undefined && (
          <span
            className="text-xs font-bold px-2 py-0.5 rounded"
            style={{
              background: `${getConfidenceColor(action.confidence)}20`,
      ...
      {action.error && (
        <div className="mt-2 text-xs" style={{ color: 'var(--fxos-danger)' }}>
          ❌ {action.error}
        </div>
      )}
    </div>
