        ...
        style={{
          background:
            template.type === 'cex'
              ...
              : 'var(--fxos-gold-dim)',
          color:
            template.type === 'cex' ? 'var(--fxos-gold)' : 'var(--fxos-gold)',
        }}
      >
          ...
          <div className="flex items-center gap-3">
            {currentStep > 0 && !editingExchangeId && (
              <button
                type="button"
                onClick={handleBack}
                className="p-2 rounded-lg hover:bg-fxos-gold-dim transition-colors"
              >
                <ChevronLeft
                  className="w-5 h-5"
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                <a
                  ...
                  style={{
                    background: 'var(--fxos-gold-dim)',
                    border: '1px solid var(--fxos-gold-glow)',
                  }}
                >
                  <UserPlus
                    className="w-4 h-4"
                ...
                <>
                  {currentExchangeType === 'binance' && (
                    <div
                      ...
                      style={{
                        background: 'var(--fxos-gold-dim)',
                        border: '1px solid var(--fxos-gold-dim)',
                      }}
                    ...
                    >
                      ...
                      {showBinanceGuide && (
                        <div
                          ...
                          style={{
                            borderTop: '1px solid var(--fxos-gold-dim)',
                            color: 'var(--text-primary)',
                          }}
                        >
                          <a
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="flex-1 px-4 py-3 rounded-xl text-sm font-semibold transition-all hover:bg-fxos-gold-dim"
                  style={{
