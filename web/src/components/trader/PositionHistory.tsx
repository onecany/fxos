  ...
  return (
    <div className="rounded-lg p-4 transition-all duration-200 hover:scale-[1.02] bg-fxos-bg-deeper border border-[rgba(45,212,191,0.16)]">
      ...
      <div className="flex items-baseline gap-1">
        <span
          className="text-xl font-bold font-mono text-fxos-text"
  ...
  return (
    <div className="flex items-center justify-between p-3 rounded-lg transition-all duration-200 hover:bg-fxos-gold/10 border-b border-[rgba(45,212,191,0.16)]">
      <div className="flex items-center gap-3">
        <span className="font-mono font-semibold text-fxos-text">
...
function PositionRow({ position }: { position: HistoricalPosition }) {
  ...
  const sideColor = isLong ? 'var(--fxos-success)' : 'var(--fxos-danger)'
  ...
  return (
    <tr
      className="transition-all duration-200 hover:bg-fxos-gold/10"
      ...
      >
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr style={{ background: 'var(--fxos-bg-lighter)' }}>
                <th
