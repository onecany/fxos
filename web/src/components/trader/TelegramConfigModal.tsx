      ...
      >
        ...
        <div className="flex items-center justify-between p-6 pb-2">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <MessageCircle className="w-6 h-6" style={{ color: 'var(--fxos-gold)' }} />
        ...
        <div className="px-6 pb-6 space-y-5">
          {isLoading ? (
            <div className="text-center py-8 text-fxos-text-muted text-sm font-mono">
              ...
              {step === 0 && (
                <div className="space-y-5">
                  <div
                    ...
                    style={{ background: 'rgba(45, 212, 191, 0.10)', border: '1px solid rgba(45, 212, 191, 0.28)' }}
                  >
                    <div className="flex items-start gap-3">
                      <span className="text-2xl">🤖</span>
                      <div>
                        <div className="font-semibold mb-1" style={{ color: 'var(--fxos-gold)' }}>
                          {t('telegram.step1Title', language)}
                        </div>
                        <div className="text-xs space-y-1" style={{ color: 'var(--text-secondary)' }}>
                          <div>1. {t('telegram.step1Desc1', language)} <code className="text-fxos-accent">@BotFather</code></div>
                          <div>2. {t('telegram.step1Desc2', language)} <code className="text-fxos-accent">/newbot</code> {t('telegram.step1Desc2Suffix', language)}</div>
                ...
                <div className="space-y-5">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <span className="text-2xl">📱</span>
                      <div>
                        <div className="font-semibold mb-1" style={{ color: 'var(--fxos-success)' }}>
                          {t('telegram.step2Title', language)}
                        </div>
                        <div className="text-xs space-y-1" style={{ color: 'var(--text-secondary)' }}>
                          <div>1. {t('telegram.step2Desc1', language)}</div>
                          <div>2. {t('telegram.step2Desc2', language)} <code className="text-fxos-success">/start</code></div>
                  ...
                  {config?.token_masked && (
                    ...
                    >
                      <div className="w-2 h-2 rounded-full bg-fxos-gold animate-pulse flex-shrink-0" />
                      <div>
                  ...
                  >
                    <div className="text-xs" style={{ color: 'var(--fxos-gold)' }}>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      style={{ background: 'var(--fxos-success)', color: '#fff' }}
                    >
              ...
              {step === 2 && (
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <div className="font-bold text-lg" style={{ color: 'var(--fxos-success)' }}>
                  ...
                  {config?.token_masked && (
                    <div
                      ...
                      style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)' }}
                    >
                      <div className="w-2 h-2 rounded-full bg-fxos-success flex-shrink-0" />
                  ...
                  >
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-start gap-2 text-xs">
                        <code className="font-mono px-1.5 py-0.5 rounded flex-shrink-0" style={{ background: 'var(--fxos-bg-lighter)', color: 'var(--fxos-gold)' }}>
                          {item.cmd}
                        </code>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      style={{ background: 'rgba(214, 67, 58, 0.1)', color: 'var(--fxos-danger)', border: '1px solid rgba(214, 67, 58, 0.2)' }}
                    >
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          style={{ background: 'var(--fxos-gold)', color: '#fff', whiteSpace: 'nowrap' }}
        >
