...
export const coinSource = {
  ...
  fxososNote: {
    zh: '使用 FXOS API Key（在指标配置中设置）',
    en: 'Uses FXOS API Key (set in Indicators config)',
    es: 'Usa API Key de FXOS',
  },
  ai500Desc: {
...
export const indicator = {
  ...
  fxososDataSources: {
    zh: 'FXOS 数据源',
    en: 'FXOS Data Sources',
    es: 'Fuentes FXOS',
  },
  configureApiKey: {
    zh: '请配置 API Key 以启用 FXOS 数据源',
    en: 'Please configure API Key to enable FXOS data sources',
    es: 'Configure API Key para habilitar FXOS',
  },
}
