...
const USER_MODE_KEY = 'fxos_user_mode'
const BEGINNER_WALLET_ADDRESS_KEY = 'fxos_beginner_wallet_address'
const BEGINNER_ONBOARDING_COMPLETED_KEY = 'fxos_beginner_onboarding_completed'
