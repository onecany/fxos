...
//
// vergex.trade now lists the FXOS origins in its enforced
// `Content-Security-Policy: frame-ancestors 'self' https://fxosos.ai
// https://www.fxosos.ai http://127.0.0.1:3000 http://localhost:3000` for the
  ...
  return (
    <div className="h-[calc(100vh-64px)] w-full">
      <iframe
        ...
        //     parent FXOS shell to an arbitrary URL.
