...
export interface CoinSourceConfig {
  ...
  // Note: API URLs are now built automatically using fxosos_api_key from IndicatorConfig
}
...
export interface IndicatorConfig {
  ...
  // ========== Unified FXOS data source configuration ==========
  // Unified FXOS API Key - used for all FXOS data sources
  fxosos_api_key?: string;
